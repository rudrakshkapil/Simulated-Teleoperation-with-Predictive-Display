...
namespace ORB_SLAM2
{
    ...
    public:
        ...
        // Take translation info from Unity
        //void settranslation(cv::Mat M);
        void settranslation(vector<float> M);

        //
        void setrotation(vector<float> R);
    ...
    private:
        ...
        //translation values from Unity
        vector<float> received_M;

        //rotation values from Unity
        vector<float> received_R;
